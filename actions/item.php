        ...
        if (!empty($current_player_items)){
            ...
            foreach ($item_token_list AS $item_key => $item_token){
                ...
                if (!empty($item_token) && !in_array($item_token, $item_token_skip) && !strstr($item_token, '-shard') && !strstr($item_token, '-star')){
                    ...
                    //$temp_iteminfo = array('item_token' => $item_token);
                    ...
                    $temp_item = new rpg_item($this_battle, $this_player, $this_robot, $temp_iteminfo);
                    ...
                    // All items appear in YELLOW
                    //$temp_item->item_type = $temp_item_type_backup;
