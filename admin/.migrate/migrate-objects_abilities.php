...
ob_echo('');
ob_echo_nobreak('Generating ability groups data file... ');
$object_groups = cms_admin::generate_object_groups_from_index($ability_index, 'ability');
cms_admin::save_object_groups_to_json($object_groups, 'ability');
ob_echo('...done!');
ob_echo('');
