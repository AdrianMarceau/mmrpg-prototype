...
// Define a deleteDir alias that automatically exits if the action fails
...
// Define a mkdir alias that automatically exits if the action fails
...
function get_parsed_object_file_markup($object_file_path){
    ...
    return array(
        'data' => normalize_file_markup(implode(PHP_EOL, $data_markup_array)),
        'functions' => normalize_file_markup(implode(PHP_EOL, $functions_markup_array))
        );
}
...
function get_empty_functions_file_markup($kind){
    ...
    return normalize_file_markup($empty_file_markup);
}
