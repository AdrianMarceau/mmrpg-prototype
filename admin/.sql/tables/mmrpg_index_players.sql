...
CREATE TABLE IF NOT EXISTS `mmrpg_index_players` (
  ...
  KEY `player_class` (`player_class`),
  KEY `player_type` (`player_type`),
  KEY `player_type2` (`player_type2`),
  KEY `player_flag_hidden` (`player_flag_hidden`),
  KEY `player_flag_complete` (`player_flag_complete`),
  KEY `player_flag_published` (`player_flag_published`),
  KEY `player_flag_hidden_complete_published` (`player_flag_hidden`,`player_flag_complete`,`player_flag_published`)
