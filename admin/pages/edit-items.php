<? ob_start(); ?>
    ...
    if ($sub_action == 'search'){
        ...
        cms_admin::object_index_search_data_clean_query_values($search_data, 'item', $backup_search_data);
        ...
        cms_admin::object_index_search_data_restore_backup_data($search_data, 'item', $backup_search_data);
    ...
    $object_group_kind = 'item';
    $object_group_class = 'item';
    $object_group_editor_url = 'admin/edit-items/groups/';
    $object_group_editor_name = 'Item Groups';
                            ...
                            <div class="panel active" data-tab="basic">
                                ...
                                <? if (!$item_data_is_new){ ?>
                                    ...
                                    <div class="field halfsize">
                                        ...
                                        <input class="textbox" type="number" name="item_shop_level" value="<?= !empty($item_data['item_shop_level']) ? $item_data['item_shop_level'] : 0 ?>" maxlength="3" min="0" max="100" step="1" />
                                    </div>
