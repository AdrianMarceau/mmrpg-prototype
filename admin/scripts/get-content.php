...
switch ($request_type) {
    ...
    case 'get-threads': {
        ...
        // Collect the category ID if it's been provided
        ...
        $community_threads_index = cms_thread::get_community_threads_index($filter_array, $pagination_array, $sorting_array);
    ...
    case 'get-threads-posts': {
        ...
        $community_threads_posts_index = array();
        // ... rest of code for getting threads and their posts ...
        exit_action('success|' . json_encode($community_threads_posts_index));
        break;
