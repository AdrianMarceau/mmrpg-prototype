	...
	if (!empty($this_player->player_robots)){
		...
		foreach ($this_player_robots AS $robot_key => $scan_robotinfo){
			...
			if (!empty($switch_robotinfo['robot_token'])){
				...
				if ($temp_robot->robot_position == 'bench'
