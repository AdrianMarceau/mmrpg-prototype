...
class rpg_ability extends rpg_object {
    ...
    public function ability_load($this_abilityinfo){
        ...
        require(MMRPG_CONFIG_ROOTDIR.'data/'.$this->ability_functions);
                            ...
                            <tbody>
                                <tr>
                                    <td class="right">
                                        ...
                                        <span class="ability_record"><?= $ability_info['ability_record_users_unlocked'] == 1 ? '1 User' : number_format($ability_info['ability_record_users_unlocked'], 0, '.', ',').' Users' ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="right">
                                        <label>Equipped To : </label>
                                        <span class="ability_record"><?= $ability_info['ability_record_robots_equipped'] == 1 ? '1 Robot' : number_format($ability_info['ability_record_robots_equipped'], 0, '.', ',').' Robots' ?></span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
