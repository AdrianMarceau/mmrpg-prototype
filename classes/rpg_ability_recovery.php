...
class rpg_ability_recovery extends rpg_recovery {
    ...
    public static function trigger_robot_recovery($this_robot, $target_robot, $this_ability, $recovery_amount, $trigger_disabled = true, $trigger_options = array()){
        ...
        rpg_canvas::apply_camera_action_flags($event_options, $this_robot, $this_ability, 'recovery');
        ...
        if (!empty($anti_recovery_robots)){
            ...
            $this_battle->events_create(
                $this_robot,
                false,
                $this_ability->recovery_options['recovery_header'],
        ...
        $this_robot->trigger_custom_function('rpg-ability_trigger-recovery_before', $extra_objects_for_this_robot);
        $target_robot->trigger_custom_function('rpg-ability_trigger-recovery_before', $extra_objects_for_other_robot);
        ...
        if ($this_ability->ability_results['this_result'] == 'success'){
            ...
            $this_robot->trigger_custom_function('rpg-ability_trigger-recovery_pre-recovery', $extra_objects_for_this_robot);
            $target_robot->trigger_custom_function('rpg-ability_trigger-recovery_pre-recovery', $extra_objects_for_other_robot);
            if ($options->return_early){ return $options->return_value; }
            ...
            if ($this_ability->recovery_options['recovery_kind'] == 'energy'){
                ...
                if ($this_ability->recovery_options['recovery_frame'] === 'damage'){
        ...
        // Trigger this robot's item function if one has been defined for this context
        $this_robot->trigger_custom_function('rpg-ability_trigger-recovery_middle', $extra_objects_for_this_robot);
        $target_robot->trigger_custom_function('rpg-ability_trigger-recovery_middle', $extra_objects_for_other_robot);
        if ($options->return_early){ return $options->return_value; }
        ...
        // Trigger this robot's item function if one has been defined for this context
        $this_robot->trigger_custom_function('rpg-ability_trigger-recovery_after', $extra_objects_for_this_robot);
        $target_robot->trigger_custom_function('rpg-ability_trigger-recovery_after', $extra_objects_for_other_robot);
