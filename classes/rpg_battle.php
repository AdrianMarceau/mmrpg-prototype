...
// Define a static public function for encouraging battle victory quotes
    ...
    public function events_markup_generate($eventinfo){
        ...
        $options['this_ability_trigger'] = isset($eventinfo['event_options']['this_ability_trigger']) ? $eventinfo['event_options']['this_ability_trigger'] : '';
        ...
        $options['this_item_trigger'] = isset($eventinfo['event_options']['this_item_trigger']) ? $eventinfo['event_options']['this_item_trigger'] : '';
        ...
        $options['this_skill_trigger'] = isset($eventinfo['event_options']['this_skill_trigger']) ? $eventinfo['event_options']['this_skill_trigger'] : '';
