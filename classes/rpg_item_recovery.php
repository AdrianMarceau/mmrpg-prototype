...
class rpg_item_recovery extends rpg_recovery {
    ...
    public function trigger_robot_recovery($this_robot, $target_robot, $this_item, $recovery_amount, $trigger_disabled = true, $trigger_options = array()){
        ...
        if ($this_robot->robot_id == $target_robot->robot_id){ //$this_item->recovery_options['recovery_kind'] == 'energy'
            ...
            $this_robot->battle->events_create($target_robot, $this, $this_item->recovery_options['recovery_header'], $this_item->item_results['this_text'], $event_options);
        } else {
            $event_options['console_show_target'] = false;
            $event_options['this_item_target'] = $this_robot->robot_id.'_'.$this_robot->robot_token;;
            $this_robot->battle->events_create($this, $target_robot, $this_item->recovery_options['recovery_header'], $this_item->item_results['this_text'], $event_options);
        }
