...
class rpg_object {
    ...
    */
    ...
    public static function load_cached_index($index_kind, $cache_token, $cache_time = null){
        ...
        $cache_filename = 'cache.'.$index_kind.'.index-'.$cache_token.'.json';
        ...
        if (file_exists($cache_base_path.$cache_filename)){
            ...
            $index_data = file_get_contents($cache_base_path.$cache_filename);
            $index_data = json_decode($index_data, true);
            //error_log('$index_data = '.print_r($index_data, true));
            return $index_data;
        }
