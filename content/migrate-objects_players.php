...
$player_sprites_list = scandir(MMRPG_CONFIG_ROOTDIR.'images/players/');
...
define('MMRPG_PLAYERS_IMAGES_DIR', MMRPG_CONFIG_ROOTDIR.'images/players/');
define('MMRPG_PLAYERS_CONTENT_DIR', MMRPG_CONFIG_ROOTDIR.'content/players/');
...
foreach ($player_index AS $player_token => $player_data){
    ...
    $sprite_path = MMRPG_CONFIG_ROOTDIR.'images/players/'.$player_token.'/';
    ...
    $shadows_path = MMRPG_CONFIG_ROOTDIR.'images/players_shadows/'.$player_token.'/';
    ...
    $content_json_data = $player_data;
    unset($content_json_data['player_id']);
    unset($content_json_data['player_functions']);
...
// MIGRATE OTHER PLAYERS

// Only migrate other players if a filter isn't present
if (empty($migration_filter)){
