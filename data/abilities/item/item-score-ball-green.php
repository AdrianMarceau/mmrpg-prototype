<?
// ITEM : GREEN SCORE BALL
$ability = array(
  'ability_name' => 'Green Score Ball',
  'ability_token' => 'item-score-ball-green',
  'ability_game' => 'MM00',
  'ability_group' => 'MMRPG/Items/Points',
  'ability_class' => 'item',
  'ability_subclass' => 'consumable',
  'ability_type' => '',
  'ability_type2' => 'nature',
  'ability_description' => 'A large green sphere that radiates with mysterious power. Using this item in battle grants the player an additional {RECOVERY}% battle points at the end of the current mission, but only if they are victorious.',
  'ability_energy' => 0,
  'ability_speed' => 10,
  'ability_recovery' => 5,
  ...
  'ability_function' => function($objects){
    ...
    $temp_reward_boost = ceil($this_battle->battle_base_points * ($this_ability->ability_recovery / 100));
    $temp_goal_break = ceil($this_battle->battle_base_turns * ($this_ability->ability_damage2 / 100));
    ...
    if (true){
      ...
      $this_battle->events_create($this_robot, false, $this_field->field_name.' Rewards',
      	$random_saying.' The mission reward was boosted by <span class="ability_name ability_type ability_type_none">'.$this_ability->ability_recovery.'%</span>! That\'s <span class="ability_name ability_type ability_type_none">'.number_format($temp_reward_boost, 0, '.', ',').'</span> battle points!<br />'.
    ...
    if (true){
      ...
      $this_player->update_session();
      $this_battle->events_create($this_robot, false, $this_field->field_name.' Rewards',
      	$random_saying.' The mission target was lowered by <span class="ability_name ability_type ability_type_none">'.$this_ability->ability_damage2.'%</span>! That\'s <span class="ability_name ability_type ability_type_none">'.number_format($temp_goal_break, 0, '.', ',').'</span> turns!<br />'.
