...
// FIRE TACKLE
$ability = array(
  'ability_name' => 'Fire Tackle',
  'ability_token' => 'fire-tackle',
  'ability_game' => 'MM01',
  'ability_class' => 'mecha',
  'ability_description' => 'The user jumps at the target and tackles it to inflict damage.',
  'ability_type' => 'flame',
  'ability_energy' => 0,
  'ability_damage' => 20,
  'ability_accuracy' => 96,
  'ability_function' => function($objects){
    ...
    $this_ability->target_options_update(array(
      ...
      'success' => array($this_frames['target'], 30, 10, 10, $this_robot->print_robot_name().' uses  '.$this_ability->print_ability_name().'!')
      ));
    ...
    $this_ability->damage_options_update(array(
      ...
      'success' => array($this_frames['impact'], -10, -10, 10, 'The '.$this_ability->print_ability_name().' crashed into the target!'),
