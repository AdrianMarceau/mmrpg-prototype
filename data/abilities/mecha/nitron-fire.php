...
$ability = array(
  ...
  'ability_function' => function($objects){
    ...
    $this_ability->damage_options_update(array(
      ...
      'success' => array($this_frames['impact'], -20, 0, 10, 'The '.$this_ability->print_name().' burned the target!', 2),
      'failure' => array($this_frames['impact'], -60, 0, -10, 'The '.$this_ability->print_name().' missed&hellip;', 2)
      ));
    $this_ability->recovery_options_update(array(
      'kind' => 'energy',
      'kickback' => array(20, 0, 0),
      'success' => array($this_frames['impact'], -20, 0, 10, 'The '.$this_ability->print_name().' ignited the target!', 2),
      'failure' => array($this_frames['impact'], -60, 0, -10, 'The '.$this_ability->print_name().' missed&hellip;', 2)
      ));
