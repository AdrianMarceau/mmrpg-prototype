...
// RING TACKLE
$ability = array(
  'ability_name' => 'Ring Tackle',
  'ability_token' => 'ring-tackle',
  'ability_game' => 'MM04',
  'ability_class' => 'mecha',
  'ability_description' => 'The user propells itself across the ground until it crashes into the target to inflict damage.',
  'ability_type' => 'space',
  'ability_energy' => 0,
  'ability_damage' => 16,
  'ability_accuracy' => 96,
  'ability_function' => function($objects){
    ...
    $this_ability->damage_options_update(array(
      ...
      'success' => array($this_frames['impact'], -20, 0, 10, 'The '.$this_ability->print_ability_name().' crashed into the target!'),
      'failure' => array($this_frames['target'], -60, 0, -10, 'The '.$this_ability->print_ability_name().' missed&hellip;')
      ));
