...
$ability = array(
  ...
  'ability_function' => function($objects){
    ...
    $this_ability->damage_options_update(array(
      ...
      'success' => array($this_frames['impact'], -20, 0, 10, 'The '.$this_ability->print_name().' crashed into the target!'),
      'failure' => array($this_frames['target'], -60, 0, -10, 'The '.$this_ability->print_name().' missed&hellip;')
      ));
