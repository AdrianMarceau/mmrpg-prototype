...
$ability = array(
  ...
  'ability_function' => function($objects){
    ...
    $this_attachment_info1['ability_frame_offset'] = array('x' => 75, 'y' => 24, 'z' => 10);
    $this_attachment_info2['ability_frame_offset'] = array('x' => 95, 'y' => -24, 'z' => 10);
    ...
    $this_ability->target_options_update(array(
      'frame' => 'shoot',
      'success' => array(0, 115, 24, 10, $this_ability->print_name().' fires a barrage of bullets!')
      ));
    $this_robot->trigger_target($target_robot, $this_ability);

    // Update the two bullet's animation frames
    $this_attachment_info1['ability_frame'] = 1;
    $this_attachment_info2['ability_frame'] = 1;
    $this_robot->set_attachment($this_attachment_token.'_1', $this_attachment_info1);
    $this_robot->set_attachment($this_attachment_token.'_2', $this_attachment_info2);
    ...
    if ($target_robot->robot_status != 'disabled'){
      ...
      $this_attachment_info = $this_robot->robot_attachments[$this_attachment_token.'_1'];
      $this_attachment_info['ability_frame'] = 2;
      $this_robot->set_attachment($this_attachment_token.'_1', $this_attachment_info);
    ...
    if (isset($this_robot->robot_attachments[$this_attachment_token.'_1'])){
      $this_robot->unset_attachments($this_attachment_token.'_1');
    }
