...
$ability = array(
  ...
  'ability_function' => function($objects){
    ...
    $this_ability->damage_options_update(array(
      ...
      'success' => array($this_frames['impact'], 10, 0, 10, 'The '.$this_ability->print_name().' zapped through the target!'),
      'failure' => array($this_frames['impact'], -30, 0, -10, 'The '.$this_ability->print_name().' missed&hellip;')
      ));
    ...
    $this_robot->update_session();
    if ($target_robot->robot_energy < 1){
