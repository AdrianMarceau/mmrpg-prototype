...
$ability = array(
  ...
  'ability_function' => function($objects){
    ...
    $this_ability->target_options_update(array(
      ...
      'success' => array($this_frames['target'], 60, 0, 10, $this_robot->print_name().' uses the  '.$this_ability->print_name().'!')
      ));
    ...
    $this_ability->damage_options_update(array(
      ...
      'success' => array($this_frames['impact'], 40, -50, 10, 'The '.$this_ability->print_name().' crashed into the target!'),
      'failure' => array($this_frames['impact'], -120, 0, -10, 'The '.$this_ability->print_name().' missed&hellip;')
      ));
    $this_ability->recovery_options_update(array(
      'kind' => 'energy',
      'kickback' => array(10, 30, 0),
      'success' => array($this_frames['impact'], 20, -40, 10, 'The '.$this_ability->print_name().' crashed into the target!'),
      'failure' => array($this_frames['impact'], -120, 0, -10, 'The '.$this_ability->print_name().' missed&hellip;')
      ));
