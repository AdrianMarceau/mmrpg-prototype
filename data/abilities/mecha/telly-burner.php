...
$ability = array(
  ...
  'ability_function' => function($objects){
    ...
    $this_ability->damage_options_update(array(
      ...
      'success' => array($this_frames['impact'], 0, 5, -10, 'The '.$this_ability->print_name().' scorched the target!'),
      'failure' => array($this_frames['impact'], 0, 5, -10, 'The '.$this_ability->print_name().' missed&hellip;')
      ));
    $this_ability->recovery_options_update(array(
      'kind' => 'energy',
      'kickback' => array(10, 0, 0),
      'success' => array($this_frames['impact'], 0, 5, -10, 'The '.$this_ability->print_name().' ignited the target!'),
      'failure' => array($this_frames['impact'], 0, 5, -10, 'The '.$this_ability->print_name().' missed&hellip;')
      ));
