...
$ability = array(
  ...
  'ability_description' => 'The user charges on the first turn to build power and raise speed by {RECOVERY2}%, then releases a powerful energy shot on the second to inflict massive damage!',
  'ability_energy' => 2,
  'ability_damage' => 38,
  ...
  'ability_function' => function($objects){
    ...
    if ($this_charge_required){
      ...
      $this_ability->recovery_options_update(array(
        ...
        'percent' => true,
        'rates' => array(100, 0, 0),
        'success' => array(2, -10, 0, -10, $this_robot->print_robot_name().'&#39;s mobility improved!'),
        'failure' => array(2, -10, 0, -10, $this_robot->print_robot_name().'&#39;s mobility was not affected&hellip;')
        ));
