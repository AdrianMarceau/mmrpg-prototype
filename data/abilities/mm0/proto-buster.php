...
$ability = array(
  ...
  'ability_description' => 'The user charges on the first turn to build power and raise speed by {RECOVERY2}%, then releases a powerful energy shot on the second to inflict massive damage!  This ability\'s charge can be held indefinitely and will continue boosting the user\'s speed for as long as it is attached.',
  'ability_energy' => 2,
  'ability_damage' => 38,
  ...
  'ability_function' => function($objects){
    ...
    $this_attachment_info = array(
      ...
      'ability_frame_offset' => array('x' => -10, 'y' => -10, 'z' => -20),
    	'attachment_speed' => 0,
    	'attachment_speed_base_percent' => 0,
        ...
        'frame' => 'taunt',
        'rates' => array(100, 0, 0),
        'success' => array(2, -10, 0, -10, 'The '.$this_ability->print_name().' charge powered up mobility systems!'),
    ...
    if ($this_charge_required){
      ...
      // Define the speed mod amount for this ability based on it's recovery
      $speed_recovery_amount = ceil($this_robot->robot_base_speed * ($this_ability->ability_recovery2 / 100));
      $this_attachment_info['attachment_speed'] = $speed_recovery_amount;
      $this_attachment_info['attachment_speed_base_percent'] = $this_ability->ability_recovery2;
