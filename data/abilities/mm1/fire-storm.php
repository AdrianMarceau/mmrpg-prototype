...
$ability = array(
    ...
    'ability_function' => function($objects){
        ...
        $this_ability->target_options_update(array(
            'frame' => 'shoot',
            'success' => array($shot_power_frame, 100 + (30 * $shot_power), 0, 10, $this_robot->print_name().' throws a '.$this_ability->print_name().'!') // [shot_power='.$shot_power.'|attachment_defense='.$this_attachment_info['attachment_defense'].']
            ));
