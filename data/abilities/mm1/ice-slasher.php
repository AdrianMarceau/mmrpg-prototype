...
$ability = array(
  ...
  'ability_function' => function($objects){
    ...
    $this_ability->target_options_update(array(
      'frame' => 'shoot',
      'success' => array(0, 110, 0, 10, $this_robot->print_name().' fires an '.$this_ability->print_name().'!')
      ));
    ...
    $this_ability->damage_options_update(array(
      ...
      'success' => array(4, -90, 0, 10, 'The '.$this_ability->print_name().' cut into the target!'),
      'failure' => array(4, -100, 0, -10, 'The '.$this_ability->print_name().' missed&hellip;')
      ));
    $this_ability->recovery_options_update(array(
      'kind' => 'energy',
      'frame' => 'taunt',
      'kickback' => array(0, 0, 0),
      'success' => array(4, -45, 0, 10, 'The '.$this_ability->print_name().' was absorbed by the target!'),
      'failure' => array(4, -100, 0, -10, 'The '.$this_ability->print_name().' had no effect&hellip;')
      ));
    ...
    if ($target_robot->robot_status != 'disabled'
      ...
      $this_ability->damage_options_update(array(
        ...
        'frame' => 'defend',
        'kickback' => array(10, 0, 0),
        'success' => array(8, 0, -6, 10, $target_robot->print_name().'&#39;s mobility was damaged!'),
      ...
      $this_ability->recovery_options_update(array(
        ...
        'frame' => 'taunt',
        'kickback' => array(0, 0, 0),
        'success' => array(8, 0, -6, 10, $target_robot->print_name().'&#39;s mobility improved!'),
