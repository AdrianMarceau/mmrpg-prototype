...
$ability = array(
  ...
  'ability_description' => 'The user charges on the first turn to build power then releases a wave of temporal energy on the second to deal massive speed damage to the opposing team!',
  'ability_type' => 'time',
  'ability_energy' => 8,
  'ability_damage' => 20,
  ...
  'ability_function' => function($objects){
    ...
    // Else if the ability flag was set, the ability is released at the target
      ...
      $speed_damage_amount = ceil(($this_ability->ability_damage / 100) * $target_robot->robot_speed);
