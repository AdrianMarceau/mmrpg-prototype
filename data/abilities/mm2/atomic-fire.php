...
$ability = array(
    ...
    'ability_description' => 'The user engulfs itself in flames then unleashes a volley of fireballs at the target to deal damage. This ability grows stronger with consecutive use, culminating in a drastic boost to the user\'s attack stat if uninterrupted.',
    'ability_type' => 'flame',
    'ability_energy' => 4,
    'ability_damage' => 10,
    'ability_accuracy' => 96,
    'ability_function' => function($objects){
        ...
        if (!isset($this_robot->robot_attachments[$this_attachment_token])){
            $this_attachment_info = array(
                ...
                'attachment_power' => 0,
                'attachment_weaknesses' => array('freeze', 'water', 'earth'),
    ...
    'ability_function_onload' => function($objects){
        ...
        if (isset($this_robot->robot_attachments[$this_attachment_token])){
            ...
            $ability_damage = ceil($this_ability->ability_base_damage + (($shot_power - 1) * 4));
