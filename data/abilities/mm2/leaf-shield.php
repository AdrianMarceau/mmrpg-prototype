  ...
  'ability_function' => function($objects){
    ...
    $this_attachment_info = array(
      ...
      'attachment_damage_breaker' => ((100 - $this_ability->ability_recovery2) / 100),
        ...
        'success' => array(1, -10, 0, -10, $this_robot->print_name().'&#39;s shields were bolstered!'),
        'failure' => array(1, -10, 0, -10, $this_robot->print_name().'&#39;s shields were bolstered!')
        ),
        ...
        'rates' => array(100, 0, 0),
        'kickback' => array(0, 0, 0),
        'success' => array(2, -2, 0, -10,  'The '.$this_ability->print_name().'&#39;s protection was lost&hellip;'),
        'failure' => array(2, -2, 0, -10,  'The '.$this_ability->print_name().'&#39;s protection was lost&hellip;')
        ),
      'ability_frame' => 0,
