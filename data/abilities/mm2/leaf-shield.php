    ...
    'ability_function' => function($objects){
        ...
        $this_attachment_info = array(
            ...
            'attachment_create' => array(
                ...
                'success' => array(1, -10, 0, -10,
                    'The '.$this_ability->print_ability_name().' resists '.$this_ability->ability_recovery2.'% of all damage!<br /> '.
            ...
            'attachment_destroy' => array(
                ...
                'success' => array(9, -10, 0, -10,
                    'The '.$this_ability->print_ability_name().' burned away!<br /> '.
        ...
        // Else if the ability flag was set, leaf shield is thrown and defense is lowered by 30%
            ...
            $this_ability->recovery_options_update(array(
                ...
                'success' => array(1, -75, 0, -10, 'The '.$this_ability->print_ability_name().' crashed the target!'),
                'failure' => array(1, -85, 0, -10, 'The '.$this_ability->print_ability_name().' missed the target...')
                ));
