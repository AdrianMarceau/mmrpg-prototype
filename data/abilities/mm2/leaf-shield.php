...
$ability = array(
  ...
  'ability_game' => 'MM02',
  'ability_description' => 'The user surrounds itself with sharp, leaf-like blades to bolster shields and raise defense by {RECOVERY2}%! The shield can also be thrown at the target for massive damage!',
  'ability_type' => 'nature',
  ...
  'ability_function' => function($objects){
    ...
    $this_attachment_info = array(
      ...
      'attachment_defense' => 0,
        ...
        'failure' => array(1, -10, 0, -10, $this_robot->print_robot_name().'&#39;s shields were not affected&hellip;')
        ),
        ...
        'failure' => array(2, -2, 0, -10, $this_robot->print_robot_name().'&#39;s shields were not affected&hellip;')
        ),
      'ability_frame' => 0,
