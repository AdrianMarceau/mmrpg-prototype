...
$ability = array(
    ...
    'ability_function' => function($objects){
        ...
        $list_shield_elements = array('green/nature', 'red/flame', 'yellow/electric', 'blue/water');
        ...
        if (!$is_summoned){
            ...
            for ($i = 1; $i <= $num_shield_pieces; $i++){
                ...
                list($temp_diamon_colour, $temp_main_element) = explode('/', $temp_attachment_elements);
                ...
                $temp_attachment_info['attachment_weaknesses'] = array($temp_main_element);
                ...
                $temp_destroy_text .= $this_robot->print_name().' is no longer protected from the '.rpg_type::print_span($temp_main_element).' type... ';
