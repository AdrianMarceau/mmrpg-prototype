...
$ability = array(
  ...
  'ability_function' => function($objects){
    ...
    if ($temp_new_damage > MMRPG_SETTINGS_MULTIPLIER_MAX){
      $temp_change_percent = MMRPG_SETTINGS_MULTIPLIER_MAX - $temp_new_damage;
      $temp_new_damage = MMRPG_SETTINGS_MULTIPLIER_MAX;
    }
