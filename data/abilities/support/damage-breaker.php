...
// DAMAGE BREAKER
$ability = array(
  'ability_name' => 'Damage Breaker',
  'ability_token' => 'damage-breaker',
  'ability_group' => 'MMRPG/Support/Damage',
  'ability_description' => 'The user alters the conditions of the field to lower the damaging effects of abilities by {DAMAGE}%! This ability appears to be unaffected by existing field multipliers.',
  'ability_speed' => -2,
  'ability_energy' => 8,
  'ability_damage' => 30,
  ...
  'ability_function' => function($objects){
    ...
    if (isset($this_field->field_multipliers['damage']) && $this_field->field_multipliers['damage'] <= MMRPG_SETTINGS_MULTIPLIER_MIN){
      ...
      $this_ability->target_options_update(array(
        ...
        'success' => array(9, 0, 0, -10,
          ...
          'But the field\'s damage wont go any lower&hellip;'
          )
        ));
    ...
    // Create or decrease the damage booster for this field
    $temp_change_percent = round($this_ability->ability_damage / 100, 1);
    $temp_new_damage = $this_field->get_multiplier('damage') - $temp_change_percent;
    if ($temp_new_damage < MMRPG_SETTINGS_MULTIPLIER_MIN){
      $temp_change_percent = $temp_new_damage + MMRPG_SETTINGS_MULTIPLIER_MIN;
      $temp_new_damage = MMRPG_SETTINGS_MULTIPLIER_MIN;
    }
    $this_field->set_multiplier('damage', $temp_new_damage);
    ...
    $this_battle->events_create($this_robot, false, $this_field->field_name.' Multipliers',
    	$random_sayings[array_rand($random_sayings)].' <span class="ability_name ability_type ability_type_damage">Damage Effects</span> were decreased by '.ceil($temp_change_percent * 100).'%!<br />'.
