...
$ability = array(
    ...
    'ability_function' => function($objects){
        ...
        if (isset($this_field->field_multipliers['damage']) && $this_field->field_multipliers['damage'] <= MMRPG_SETTINGS_MULTIPLIER_MIN){
            ...
            $this_ability->target_options_update(array(
                ...
                'success' => array(9, 0, 0, -10,
                    ...
                    'But the field\'s damage won\'t go any lower&hellip;'
                    )
                ));
        ...
        if ($this_field->field_multipliers['damage'] <= MMRPG_SETTINGS_MULTIPLIER_MIN){
            $temp_change_percent = $this_field->field_multipliers['damage'] + MMRPG_SETTINGS_MULTIPLIER_MIN;
            $this_field->field_multipliers['damage'] = MMRPG_SETTINGS_MULTIPLIER_MIN;
        }
