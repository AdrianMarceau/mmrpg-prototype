    ...
    'ability_function' => function($objects){
        ...
        $temp_defense_function = function($this_robot, $this_ability, $temp_this_defense, $temp_target_defense){
            ...
            if ($temp_this_defense != $temp_target_defense){
                ...
                $this_ability->target_options_update(array(
                    'frame' => 'defend',
                    'success' => array(9, 0, 10, -10, $this_robot->print_name().'&#39;s defense was modified&hellip;<br /> '.($is_her ? 'Her' : ($is_mecha ? 'Its' : 'His')).' new defense stats are '.$this_robot->print_defense().' / '.$this_robot->print_robot_base_defense().'!')
                    ));
            ...
            // Otherwise, if the two already have equal defense amounts
                ...
                $this_ability->target_options_update(array(
                    'frame' => 'defend',
                    'success' => array(9, 0, 0, -10, $this_robot->print_name().'&#39;s defense was not affected&hellip;')
                    ));
                $this_robot->trigger_target($this_robot, $this_ability, array('prevent_default_text' => true));
