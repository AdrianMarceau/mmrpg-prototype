    ...
    if (!empty($this_field_multipliers)){
      ...
      foreach ($this_field_multipliers AS $type_token => $type_multiplier){
        ...
        if (!empty($temp_modify_amount)){
          ...
          $temp_first_amount = $this_field->get_multiplier($type_token);
          $temp_new_amount = $temp_first_amount * $type_multiplier;
          $temp_new_amount = round($temp_new_amount, 1);
          $this_field->set_multiplier($type_token, $temp_new_amount);
          ...
          if ($temp_new_amount > $temp_first_amount){
            ...
            //$temp_change_alert = rpg_functions::get_random_positive_word();
            $temp_change_alert = $this_player->player_side == 'left' ? rpg_functions::get_random_positive_word() : rpg_functions::get_random_negative_word();
          ...
          if (true){
            ...
            $this_star_index = rpg_prototype::star_image($type_token);
