...
$ability = array(
    ...
    'ability_function' => function($objects){
        ...
        if (isset($this_field->field_multipliers['recovery']) && $this_field->field_multipliers['recovery'] >= MMRPG_SETTINGS_MULTIPLIER_MAX){
            ...
            $this_ability->target_options_update(array(
                ...
                'success' => array(9, 0, 0, -10,
                    ...
                    'But the field\'s recovery won\'t go any higher&hellip;'
                    )
                ));
        ...
        if ($this_field->field_multipliers['recovery'] >= MMRPG_SETTINGS_MULTIPLIER_MAX){
            $temp_change_percent = MMRPG_SETTINGS_MULTIPLIER_MAX - $this_field->field_multipliers['recovery'];
            $this_field->field_multipliers['recovery'] = MMRPG_SETTINGS_MULTIPLIER_MAX;
        }
