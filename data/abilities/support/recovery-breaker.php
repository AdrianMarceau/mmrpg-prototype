...
$ability = array(
  ...
  'ability_function' => function($objects){
    ...
    if ($temp_new_recovery < MMRPG_SETTINGS_MULTIPLIER_MIN){
      $temp_change_percent = $temp_new_recovery + MMRPG_SETTINGS_MULTIPLIER_MIN;
      $temp_new_recovery = MMRPG_SETTINGS_MULTIPLIER_MIN;
    }
