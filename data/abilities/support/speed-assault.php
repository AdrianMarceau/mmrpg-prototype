...
$ability = array(
    ...
    'ability_description' => 'The user triggers mobility damage to all robots on the target\'s side of the field to lower speed by up to {DAMAGE}%!',
    'ability_energy' => 6,
    'ability_speed' => -1,
    'ability_damage' => 22,
        ...
        if ($backup_robots_active_count > 0){
            ...
            foreach ($backup_robots_active AS $key => $info){
                ...
                $this_ability->damage_options_update(array(
                    ...
                    'percent' => true,
                    'kickback' => array(10, 0, 0),
                    'success' => array(0, -2, 0, -10, $temp_target_robot->print_name().'&#39;s mobility was damaged!'),
                    'failure' => array(9, -2, 0, -10, 'It had no effect on '.$temp_target_robot->print_name().'&hellip;')
                    ));
