...
$ability = array(
    ...
    'ability_description' => 'The user harshly lowers its own attack and defense stats in exchange for a maxed-out speed stat to improve mobility! However, the weapon energy cost for this ability increases after each use.',
    'ability_energy' => 8,
    ...
    'ability_function' => function($objects){
        ...
        $raise_stat = 'speed';
        $lower_stats = array('attack', 'defense');
