...
$ability = array(
    ...
    'ability_description' => 'The user triggers mobility optimizations for all robots on their side of the field to boost speed by up to {RECOVERY}%!',
    'ability_energy' => 6,
    'ability_speed' => -1,
    'ability_recovery' => 22,
    ...
    'ability_function' => function($objects){
        ...
        if ($backup_robots_active_count > 0){
            ...
            foreach ($backup_robots_active AS $key => $info){
                ...
                $speed_recovery_amount = ceil($temp_this_robot->robot_speed * ($this_ability->ability_recovery / 100));
