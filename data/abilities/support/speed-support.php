...
$ability = array(
    ...
    'ability_description' => 'The user triggers mobility optimizations for all robots on their side of the field to raise their speed stats!',
    'ability_energy' => 6,
    ...
    'ability_function' => function($objects){
        ...
        if ($backup_robots_active_count > 0){
            ...
            foreach ($backup_robots_active AS $key => $info){
                ...
                rpg_ability::ability_function_stat_boost($temp_this_robot, 'speed', 1, $this_ability);
                $this_key++;
            }
        }
