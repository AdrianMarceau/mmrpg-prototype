  ...
  'ability_function' => function($objects){
    ...
    if ($this_robot->player_id == $target_robot->player_id){
      ...
      $this_ability->recovery_options_update(array(
        ...
        'percent' => true,
        'frame' => 'taunt',
        'success' => array(0, -2, 0, -10, $target_robot->print_robot_name().'&#39;s mobility improved!'),
        'failure' => array(9, -2, 0, -10, $target_robot->print_robot_name().'&#39;s mobility was not affected&hellip;')
        ));
