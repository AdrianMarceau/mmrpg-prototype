...
$ability = array(
  ...
  'ability_description' => 'The user lowers its attack and defense by {DAMAGE}% to greatly raise speed and improve mobility by {RECOVERY}%!',
  'ability_energy' => 6,
  'ability_recovery' => 90,
  ...
  'ability_function' => function($objects){
    ...
    $this_ability->damage_options_update(array(
      ...
      'frame' => 'defend',
      'percent' => true,
      'success' => array(1, -2, 0, -10,  $this_robot->print_name().'&#39;s shields powered down&hellip;'),
    ...
    $this_ability->damage_options_update(array(
      ...
      'frame' => 'defend',
      'percent' => true,
      'success' => array(2, -4, 0, -10,  $this_robot->print_name().'&#39;s weapons powered down&hellip;'),
      'failure' => array(9, -4, 0, -10, $this_robot->print_name().'&#39;s weapons were not affected&hellip;')
      ));
    ...
    $this_ability->recovery_options_update(array(
      ...
      'frame' => 'taunt',
      'percent' => true,
      'success' => array(0, -6, 0, -10,  $this_robot->print_name().'&#39;s mobility improved&hellip;'),
      'failure' => array(9, -6, 0, -10, $this_robot->print_name().'&#39;s mobility was not affected&hellip;')
      ));
    $speed_recovery_amount = ceil($this_robot->robot_attack * ($this_ability->ability_recovery / 100));
