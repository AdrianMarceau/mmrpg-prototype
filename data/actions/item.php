...
ob_start();
  ...
  <div class="main_actions main_actions_hastitle">
    ...
    if (!empty($current_player_items)){
      ...
      $item_token_skip = array('item-screw-large', 'item-screw-small', 'item-core-none');
        ...
        if (!empty($item_token) && !in_array($item_token, $item_token_skip)){
          ...
          */
          ...
          $temp_item_label .= '<span class="subtext">';
            ...
            if (!empty($temp_type2)){ $temp_item_label .= ' / '.$mmrpg_index['types'][$temp_item->ability_type2]['type_name']; }
