...
CREATE TABLE IF NOT EXISTS `mmrpg_index_players` (
  ...
  `player_group` varchar(100) NOT NULL COMMENT 'Player Group',
  ...
  `player_type2` varchar(32) NOT NULL COMMENT 'Player Type 2',
