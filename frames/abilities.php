...
if (true){
    ...
    ob_start();
        ...
        ?>
        <div class="event event_double event_visible" data-token="abilities">
                                ...
                                <table class="full" style="margin-bottom: 5px;">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($mmrpg_database_abilities AS $ability_token => $ability_info){
                                            ...
                                            ?>
                                            <td class="<?= $ability_cell_float ?> ability_cell<?= $temp_is_disabled ? ' ability_cell_disabled' : '' ?><?= !$temp_is_complete ? ' ability_cell_incomplete' : '' ?>"
                                                data-kind="ability" data-action="use-ability" data-token="<?= !$temp_is_comingsoon ? $ability_info_token : 'comingsoon' ?>"
                                                data-unlocked="<?= $temp_is_comingsoon ? 'coming-soon' : 'true' ?>"
                                                <?= !empty($temp_info_tooltip) ?
                                                    'data-click-tooltip="'.$temp_info_tooltip.'" '.
                                                    'data-tooltip-type="type_'.$ability_info_type.'"'
                                                    : '' ?>>
                                                ...
                                                <span class="ability_name ability_type ability_type_<?= $ability_info_type ?>"><?= str_replace(' ', '<br />', $ability_info_name) ?></span>
