...
<script type="text/javascript" src="scripts/frames.database.js?<?=MMRPG_CONFIG_CACHE_DATE?>"></script>
...
// Define the markup variables for the script to load
gameSettings.databaseCanvasMarkup = '<?= str_replace("'", "\\'", $database_canvas_markup) ?>';
gameSettings.databaseConsoleMarkup = '<?= str_replace("'", "\\'", $database_console_markup) ?>';
</script>
</head>
