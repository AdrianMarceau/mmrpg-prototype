...
function parse_editor_indexes(
  ...
  if (MMRPG_CONFIG_DEBUG_MODE){ mmrpg_debug_checkpoint(__FILE__, __LINE__, 'parse_editor_indexes()');  }
...
function refresh_editor_arrays(
  ...
  if (MMRPG_CONFIG_DEBUG_MODE){ mmrpg_debug_checkpoint(__FILE__, __LINE__, 'refresh_editor_arrays()');  }
  global $session_token;
