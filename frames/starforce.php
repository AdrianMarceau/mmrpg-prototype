                    ...
                    <div class="types_container" style="">
                        ...
                        if (!empty($this_star_force)){
                            ...
                            foreach ($this_star_force AS $force_type => $force_count){
                                ...
                                $temp_data_class = 'field_type field_type_'.$force_type;
                                $temp_data_style = 'padding-right: '.$temp_padding_amount.'px;';
                                $temp_data_tooltip = ucfirst($force_type).' +'.($force_count).' | '.$force_count_strict.' / '.$this_battle_stars_count.' Stars';
                                $temp_label_text = ucfirst($force_type).' &plus;'.$force_count;
                                echo '<div data-tooltip="'.$temp_data_tooltip.'" class="'.$temp_data_class.'" style="'.$temp_data_style.'" data-padding="'.$temp_padding_amount.'">'.$temp_label_text.'</div>';
                            }
