...
<link type="text/css" href="styles/stars_backup.css?<?=MMRPG_CONFIG_CACHE_DATE?>" rel="stylesheet" />
<?if($flag_wap):?>
...
<script type="text/javascript" src="scripts/stars_backup.js?<?=MMRPG_CONFIG_CACHE_DATE?>"></script>
