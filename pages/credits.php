...
foreach ($contributor_ids AS $id){
  ...
  <div class="subbody" style="position: relative; padding-left: 60px; margin-bottom: 2px; ">
    ...
    <div class="text">
      <div>
        <a class="player_type player_type_<?= $temp_playertype ?>" style="padding: 1px 6px 2px 22px; background: transparent url(images/items/<?= $temp_itemkind ?>/icon_left_40x40.png) scroll no-repeat -10px -11px; text-decoration: none; " href="leaderboard/<?= $temp_userinfo['user_name_clean'] ?>/"><strong><?= $temp_displayname ?></strong></a>
