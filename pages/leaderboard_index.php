...
$this_seo_description = 'The Mega Man RPG Prototype currently has '.(!empty($this_leaderboard_count) ? ($this_leaderboard_count == 1 ? '1 player' : $this_leaderboard_count.' players') : '0 players').' players and that number is growing all the time. The leaderboard below ranks all players based on their total Battle Point scores, with the best of the best prominantly displayed at the top. Players earn Battle Points throughout the course of the game by completing certain events, collecting items, unlocking new robots or abilities, and by doing or collecting lots of other things as well. Use the numbered links at the top and bottom of the page to navigate and let us know if you have any questions or concerns.';
...
<div class="subbody" style="margin-bottom: 6px;">
        ...
        <p class="text">
            ...
            and that number is growing all the time.  The leaderboard below ranks all players based on their total Battle Point scores, with the best of the best prominantly displayed at the top.
            Players earn Battle Points throughout the course of the game by completing certain events, collecting items, unlocking new robots or abilities, and by doing or collecting lots of other things as well.
            Use the numbered links at the top and bottom of the page to navigate and <a style="text-decoration: none;" href="contact/">let us know</a> if you have any questions or concerns.
        </p>
