...
<div class="subbody">
  ...
  <div class="float float_right"><div class="sprite sprite_80x80 sprite_80x80_<?= rpg_robot::random_frame() ?>" style="background-image: url(images/robots/guts-man/sprite_left_80x80.png?<?= MMRPG_CONFIG_CACHE_DATE ?>);">Guts Man</div></div>
  <p class="text">
  ...
  <div class="float float_left"><div class="sprite sprite_80x80 sprite_80x80_<?= rpg_robot::random_frame() ?>" style="background-image: url(images/robots/air-man/sprite_right_80x80.png?<?= MMRPG_CONFIG_CACHE_DATE ?>);">Air Man</div></div>
...
<div class="subbody" style="margin-top: 20px;">
  <div class="float float_right"><div class="sprite sprite_80x80 sprite_80x80_<?= rpg_robot::random_frame() ?>" style="background-image: url(images/robots/robot/sprite_left_80x80.png?<?= MMRPG_CONFIG_CACHE_DATE ?>);">Robot</div></div>
  <p class="text">
