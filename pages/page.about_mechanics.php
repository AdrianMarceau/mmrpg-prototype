...
<div class="subbody">
  <div class="float float_right"><div class="sprite sprite_80x80 sprite_80x80_<?= rpg_robot::random_frame() ?>" style="background-image: url(images/robots/wood-man/sprite_left_80x80.png);"></div></div>
...
<div class="subbody">
  ...
  <div class="float float_right"><div class="sprite sprite_80x80 sprite_80x80_<?= rpg_robot::random_frame() ?>" style="background-image: url(images/robots/crash-man/sprite_left_80x80.png?<?= MMRPG_CONFIG_CACHE_DATE ?>);">Crash Man</div></div>
  ...
  <div class="float float_left"><div class="sprite sprite_80x80 sprite_80x80_<?= rpg_robot::random_frame() ?>" style="background-image: url(images/robots/bomb-man/sprite_right_80x80.png?<?= MMRPG_CONFIG_CACHE_DATE ?>);">Bomb Man</div></div>
  ...
  <div class="float float_right"><div class="sprite sprite_80x80 sprite_80x80_<?= rpg_robot::random_frame() ?>" style="background-image: url(images/robots/flash-man/sprite_left_80x80.png?<?= MMRPG_CONFIG_CACHE_DATE ?>);">Flash Man</div></div>
