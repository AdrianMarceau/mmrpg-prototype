...
<div class="subbody" style="min-height: 85px; overflow: visible;">
  <div class="float float_right" style="width: 80px; height: 80px; position: relative;">
    <div class="sprite sprite_80x80 sprite_80x80_<?= rpg_robot::random_frame() ?>" style="position: absolute; left: -18px; bottom: -6px; z-index: 2; background-image: url(images/robots/trill/sprite_left_80x80.png);"></div>
    <div class="sprite sprite_160x160 sprite_160x160_<?= rpg_robot::random_frame() ?>" style="position: absolute; left: -30px; bottom: -6px; z-index: 1; background-image: url(images/robots/slur/sprite_left_160x160.png);"></div>
  </div>
      ...
      <div class="field field_panel field_panel_foreground" style="background-image: url(images/fields/intro-field/battle-field_foreground_base.png?<?= MMRPG_CONFIG_CACHE_DATE ?>);">
        <div class="wrap">
          ...
          <span style="position: relative; top: -12px; z-index: 1; padding-right: 0;">
            <span class="sprite_image sprite_image_40x40 sprite_image_40x40_<?= rpg_functions::weighted_chance(array('shoot', 'summon', 'taunt', 'defend'), array(3, 3, 2, 2)) ?>" style="position: relative; top: 21px; margin-left: 0; z-index: 8;"><span><img src="images/robots/metal-man/sprite_right_40x40.png?<?= MMRPG_CONFIG_CACHE_DATE ?>" alt="Metal Man" /></span></span>
            <span class="sprite_image sprite_image_40x40 sprite_image_40x40_<?= rpg_functions::weighted_chance(array('shoot', 'summon', 'taunt', 'defend'), array(3, 3, 2, 2)) ?>" style="position: relative; top: 18px; margin-left: -9px; z-index: 7;"><span><img src="images/robots/bubble-man/sprite_right_40x40.png?<?= MMRPG_CONFIG_CACHE_DATE ?>" alt="Bubble Man" /></span></span>
            <span class="sprite_image sprite_image_40x40 sprite_image_40x40_<?= rpg_functions::weighted_chance(array('shoot', 'summon', 'taunt', 'defend'), array(3, 3, 2, 2)) ?>" style="position: relative; top: 15px; margin-left: -9px; z-index: 6;"><span><img src="images/robots/flash-man/sprite_right_40x40.png?<?= MMRPG_CONFIG_CACHE_DATE ?>" alt="Flash Man" /></span></span>
            <span class="sprite_image sprite_image_40x40 sprite_image_40x40_<?= rpg_functions::weighted_chance(array('shoot', 'summon', 'taunt', 'defend'), array(3, 3, 2, 2)) ?>" style="position: relative; top: 12px; margin-left: -9px; z-index: 5;"><span><img src="images/robots/crash-man/sprite_right_40x40.png?<?= MMRPG_CONFIG_CACHE_DATE ?>" alt="Crash Man" /></span></span>
            <span class="sprite_image sprite_image_40x40 sprite_image_40x40_<?= rpg_functions::weighted_chance(array('shoot', 'summon', 'taunt', 'defend'), array(3, 3, 2, 2)) ?>" style="position: relative; top: 9px; margin-left: -9px; z-index: 4;"><span><img src="images/robots/wood-man/sprite_right_40x40.png?<?= MMRPG_CONFIG_CACHE_DATE ?>" alt="Wood Man" /></span></span>
            <span class="sprite_image sprite_image_40x40 sprite_image_40x40_<?= rpg_functions::weighted_chance(array('shoot', 'summon', 'taunt', 'defend'), array(3, 3, 2, 2)) ?>" style="position: relative; top: 6px; margin-left: -9px; z-index: 3;"><span><img src="images/robots/heat-man/sprite_right_40x40.png?<?= MMRPG_CONFIG_CACHE_DATE ?>" alt="Heat Man" /></span></span>
            <span class="sprite_image sprite_image_40x40 sprite_image_40x40_<?= rpg_functions::weighted_chance(array('shoot', 'summon', 'taunt', 'defend'), array(3, 3, 2, 2)) ?>" style="position: relative; top: 3px; margin-left: -9px; z-index: 2;"><span><img src="images/robots/quick-man/sprite_right_40x40.png?<?= MMRPG_CONFIG_CACHE_DATE ?>" alt="Quick Man" /></span></span>
            <span class="sprite_image sprite_image_40x40 sprite_image_40x40_<?= rpg_functions::weighted_chance(array('shoot', 'summon', 'taunt', 'defend'), array(3, 3, 2, 2)) ?>" style="position: relative; top: 0; margin-left: -9px; z-index: 1;"><span><img src="images/robots/air-man/sprite_right_40x40.png?<?= MMRPG_CONFIG_CACHE_DATE ?>" alt="Air Man" /></span></span>
          </span>
          ...
          <span style="position: relative; top: -12px; z-index: 1; padding-left: 0;">
            <span class="sprite_image sprite_image_40x40 sprite_image_40x40_<?= rpg_functions::weighted_chance(array('shoot', 'summon', 'taunt', 'defend'), array(3, 3, 2, 2)) ?>" style="position: relative; top: 0; margin-left: -9px; z-index: 1;"><span><img src="images/robots/drill-man/sprite_left_40x40.png?<?= MMRPG_CONFIG_CACHE_DATE ?>" alt="Drill Man" /></span></span>
            <span class="sprite_image sprite_image_80x80 sprite_image_80x80_<?= rpg_functions::weighted_chance(array('shoot', 'summon', 'taunt', 'defend'), array(3, 3, 2, 2)) ?>" style="position: relative; top: 3px; margin-left: -9px; z-index: 2;"><span><img src="images/robots/toad-man/sprite_left_80x80.png?<?= MMRPG_CONFIG_CACHE_DATE ?>" alt="Toad Man" /></span></span>
            <span class="sprite_image sprite_image_40x40 sprite_image_40x40_<?= rpg_functions::weighted_chance(array('shoot', 'summon', 'taunt', 'defend'), array(3, 3, 2, 2)) ?>" style="position: relative; top: 6px; margin-left: -9px; z-index: 3;"><span><img src="images/robots/bright-man/sprite_left_40x40.png?<?= MMRPG_CONFIG_CACHE_DATE ?>" alt="Bright Man" /></span></span>
            <span class="sprite_image sprite_image_40x40 sprite_image_40x40_<?= rpg_functions::weighted_chance(array('shoot', 'summon', 'taunt', 'defend'), array(3, 3, 2, 2)) ?>" style="position: relative; top: 9px; margin-left: -9px; z-index: 4;"><span><img src="images/robots/pharaoh-man/sprite_left_40x40.png?<?= MMRPG_CONFIG_CACHE_DATE ?>" alt="Pharaoh Man" /></span></span>
            <span class="sprite_image sprite_image_40x40 sprite_image_40x40_<?= rpg_functions::weighted_chance(array('shoot', 'summon', 'taunt', 'defend'), array(3, 3, 2, 2)) ?>" style="position: relative; top: 12px; margin-left: -9px; z-index: 5;"><span><img src="images/robots/ring-man/sprite_left_40x40.png?<?= MMRPG_CONFIG_CACHE_DATE ?>" alt="Ring Man" /></span></span>
            ...
            <span class="sprite_image sprite_image_80x80 sprite_image_80x80_<?= rpg_functions::weighted_chance(array('shoot', 'summon', 'taunt', 'defend'), array(3, 3, 2, 2)) ?>" style="position: relative; top: 18px; margin-left: -9px; z-index: 7;"><span><img src="images/robots/dive-man/sprite_left_80x80.png?<?= MMRPG_CONFIG_CACHE_DATE ?>" alt="Dive Man" /></span></span>
