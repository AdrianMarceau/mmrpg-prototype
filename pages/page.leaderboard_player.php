...
<div class="community leaderboard">
  <div class="subbody thread_subbody thread_subbody_full thread_subbody_full_right thread_right" style="text-align: left; position: relative; padding-bottom: 0; margin-bottom: 4px;">
    ...
    <div class="<?= $temp_avatar_class ?> avatar_userimage" style="margin-top: 0;"  title="<?= isset($temp_item_title) ? $temp_item_title : 'Member' ?>" data-tooltip-type="type player_type_<?= !empty($this_playerinfo['user_colour_token']) ? $this_playerinfo['user_colour_token'] : 'none' ?>">
      <?php if($temp_is_contributor): ?><div class="<?= $temp_item_class ?>" style="background-image: url(<?= $temp_item_path ?>); position: absolute; top: -22px; right: -30px;" alt="<?= $temp_item_title ?>"><?= $temp_item_title ?></div><?php endif; ?>
  ...
  <?php $temp_colour_token = !empty($this_playerinfo['user_colour_token']) ? $this_playerinfo['user_colour_token'] : 'none'; ?>
  <h2 class="subheader field_type_<?= $temp_colour_token ?>" style="margin: 10px 0 4px; text-align: left;">
    <?= $temp_display_name?>&#39;s Leaderboard
    <span class="count" style="position: relative; bottom: 1px;"><?php
  ...
  <div class="subbody thread_subbody thread_subbody_full thread_subbody_full_right thread_right event event_triple event_visible" style="text-align: left; position: relative; padding-bottom: 6px; margin-bottom: 4px;">
    ...
    <div id="game_buttons" data-fieldtype="<?= !empty($this_playerinfo['user_colour_token']) ? $this_playerinfo['user_colour_token'] : 'none' ?>" class="field" style="margin: 0 auto 20px; <?= $this_current_token == 'threads' || $this_current_token == 'posts' ? 'padding-bottom: 6px;' : '' ?>">
      ...
      <?php if(!empty($temp_show_players)): ?>
      ...
      <?php endif; ?>
      <?php if(!empty($temp_show_starforce)): ?>
      ...
      <?php if(!empty($this_playerinfo['thread_count'])): ?>
      ...
      <?php endif; ?>
      <?php if(!empty($this_playerinfo['post_count'])): ?>
      ...
      <?php endif; ?>
      <?php if (!empty($this_playerinfo['user_website_address']) && preg_match('/^([^@]+)@([^@]+)$/i', $this_playerinfo['user_website_address'])): ?>
        <a class="link_button field_type field_type_empty" href="mailto:<?= $this_playerinfo['user_website_address'] ?>" target="_blank">Email</a>
      <?php elseif (!empty($this_playerinfo['user_website_address'])): ?>
        <a class="link_button field_type field_type_empty" href="<?= $this_playerinfo['user_website_address'] ?>" target="_blank">Website</a>
      <?php endif; ?>
      <?php if ($this_userid != MMRPG_SETTINGS_GUEST_ID && $this_userid != $this_playerinfo['user_id'] && !empty($this_userinfo['user_flag_postprivate'])): ?>
    ...
    if (empty($this_current_token) || !in_array($this_current_token, $temp_allowed_pages)){
      ?>
        ...
        <div class="bodytext" style="overflow: hidden; margin-bottom: 0;">
          <div class="text player_stats">
            ...
            <ul class="records">
              ...
              <?php $this_playerinfo['comment_count'] = $this_playerinfo['post_count'] + $this_playerinfo['thread_count']; ?>
              <?php $this_playerinfo['comment_rating'] = round(($this_playerinfo['post_count'] * 2) - ($this_playerinfo['thread_count'] / 2)); ?>
              <?php if($this_playerinfo['comment_rating'] != 0): ?>
          ...
          <div class="text player_stats">
            ...
            <ul class="records">
              ...
              <?php $this_playerinfo['battle_count'] = $this_playerinfo['victory_count'] + $this_playerinfo['defeat_count']; ?>
              <?php $this_playerinfo['battle_rating'] = round(($this_playerinfo['victory_count'] * 2) - ($this_playerinfo['defeat_count'] / 2)); ?>
              <?php if($this_playerinfo['battle_rating'] != 0): ?>
          ...
          <div class="text player_stats">
            <strong class="label">Starforce Stats</strong>
            <ul class="records">
              <?php if(!empty($temp_counter_stars['total'])): ?>
          ...
          <div class="text player_stats">
            ...
            <ul class="records">
              <?php $temp_unlocked_summoned_total = $temp_counter_database['unlocked']['total'] + $temp_counter_database['summoned']['total']; ?>
              <?php if(!empty($temp_counter_database['total'])): ?>
        ...
        <div class="bodytext" style="margin-top: 15px;">
          <?php if(!empty($temp_display_text)): ?>
            <?= str_replace('<p>', '<p class="text">', rpg_website::formatting_decode($temp_display_text))."\n" ?>
          <?php else: ?>
  ...
  if ($this_current_token == 'threads'){
    ...
    if (!empty($this_threads_array)){
      ...
      <div class="subbody posts_body thread_right event event_triple event_visible" style="margin-top: -6px;">
        <div class="text" style="font-size: 110%; padding: 6px 0 0;">
          ...
          <div class="thread_header_links">
            <strong>Limit To</strong><br />
            <?php if($this_threads_count > 10): ?><a href="<?= MMRPG_CONFIG_ROOTURL.'leaderboard/'.$this_playerinfo['user_name_clean'].'/threads/?sort='.$temp_thread_sort.'&amp;show=10' ?>" rel="nofollow" style="text-decoration: <?= $temp_thread_show == 10 ? 'underline' : 'none' ?>;">10</a> <span class="pipe">|</span><?php endif; ?>
            <?php if($this_threads_count > 50): ?><a href="<?= MMRPG_CONFIG_ROOTURL.'leaderboard/'.$this_playerinfo['user_name_clean'].'/threads/?sort='.$temp_thread_sort.'&amp;show=50' ?>" rel="nofollow" style="text-decoration: <?= $temp_thread_show == 50 ? 'underline' : 'none' ?>;">50</a> <span class="pipe">|</span><?php endif; ?>
            <?php if($this_threads_count > 100): ?><a href="<?= MMRPG_CONFIG_ROOTURL.'leaderboard/'.$this_playerinfo['user_name_clean'].'/threads/?sort='.$temp_thread_sort.'&amp;show=100' ?>" rel="nofollow" style="text-decoration: <?= $temp_thread_show == 100 ? 'underline' : 'none' ?>;">100</a> <span class="pipe">|</span><?php endif; ?>
            <?php if($this_threads_count > 200): ?><a href="<?= MMRPG_CONFIG_ROOTURL.'leaderboard/'.$this_playerinfo['user_name_clean'].'/threads/?sort='.$temp_thread_sort.'&amp;show=200' ?>" rel="nofollow" style="text-decoration: <?= $temp_thread_show == 200 ? 'underline' : 'none' ?>;">200</a> <span class="pipe">|</span><?php endif; ?>
            <?php if($this_threads_count > 500): ?><a href="<?= MMRPG_CONFIG_ROOTURL.'leaderboard/'.$this_playerinfo['user_name_clean'].'/threads/?sort='.$temp_thread_sort.'&amp;show=500' ?>" rel="nofollow" style="text-decoration: <?= $temp_thread_show == 500 ? 'underline' : 'none' ?>;">500</a> <span class="pipe">|</span><?php endif; ?>
        ...
        <?php if(!empty($this_threads_count)): ?>
      ...
      <div class="subbody posts_body post_left event event_triple event_visible" style="margin-top: -6px;">
        <div class="text" style="font-size: 110%; padding: 6px 3px 0;">
          ...
          <div class="post_header_links">
            ...
            <?php if($this_posts_count > 100): ?><a href="<?= MMRPG_CONFIG_ROOTURL.'leaderboard/'.$this_playerinfo['user_name_clean'].'/posts/?sort='.$temp_post_sort.'&amp;show=100' ?>" rel="nofollow" style="text-decoration: <?= $temp_post_show == 100 ? 'underline' : 'none' ?>;">100</a> <span class="pipe">|</span><?php endif; ?>
...
<?php if(false): ?>
  <div style="padding: 10px; color: white;">
	  ...
	  <hr />
	  <pre>$temp_counter_points : <?= print_r($temp_counter_points, true) ?></pre>
	  <hr />
	  <pre>$temp_counter_missions : <?= print_r($temp_counter_missions, true) ?></pre>
	  <hr />
	  <pre>$temp_counter_robots : <?= print_r($temp_counter_robots, true) ?></pre>
	  <hr />
	  <pre>$temp_counter_abilities : <?= print_r($temp_counter_abilities, true) ?></pre>
	  <hr />
	  <pre>$temp_counter_levels : <?= print_r($temp_counter_levels, true) ?></pre>
	  <hr />
  </div>
<?php endif; ?>
