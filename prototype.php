...
if (MMRPG_CONFIG_ADMIN_MODE && !empty($temp_flags)){
  ...
  foreach ($mmrpg_index_players AS $player_token => $player_info){
    ...
    foreach ($this_ability_index AS $ability_token => $ability_info){
      if (rpg_game::ability_unlocked($player_token, false, $ability_token)){ continue; }
    ...
    foreach ($this_robot_index AS $robot_token => $robot_info){
      if (rpg_game::robot_unlocked(false, $robot_token)){ continue; }
      ...
      if ($robot_token != 'robot' && !empty($temp_flags[$player_string.'_password_robot'.$robot_string])){
        ...
        rpg_game::unlock_robot($player_info, $robot_info, true);
        // And now redirect to the same page
        header('Location: prototype.php?wap='.($flag_wap ? 'true' : 'false'));
        exit();
      }
...
require('prototype/prototype.awards.php');
...
<div id="prototype" class="hidden">
  ...
  <div class="banner">
    ...
    <div class="points field_type field_type_<?= MMRPG_SETTINGS_CURRENT_FIELDTYPE ?>">
      <a class="wrapper link link_leaderboard" data-step="leaderboard" data-index="99" data-source="frames/frame.leaderboard.php" data-music="misc/leader-board" data-tooltip="<?= $this_menu_tooltips['leaderboard'] ?>" data-tooltip-type="field_type field_type_<?= MMRPG_SETTINGS_CURRENT_FIELDTYPE ?>">
    ...
    <div class="options options_userinfo field_type field_type_<?= MMRPG_SETTINGS_CURRENT_FIELDTYPE ?>">
      ...
      <?php if(rpg_game::is_user()): ?>
        <a class="wrapper link link_save" data-step="file_save" data-index="98" data-source="frames/frame.file.php?action=save" data-music="misc/file-menu" data-tooltip="<?= $this_menu_tooltips['save'] ?>" data-tooltip-type="field_type field_type_<?= MMRPG_SETTINGS_CURRENT_FIELDTYPE ?>">
    ...
    <div class="options options_fullmenu field_type field_type_<?= MMRPG_SETTINGS_CURRENT_FIELDTYPE ?>">
      ...
      if (rpg_game::is_demo()){
        ...
        <a class="link link_data" data-step="database" data-index="<?= $temp_data_index++ ?>" data-source="frames/frame.database.php" data-music="misc/data-base" data-tooltip="<?= $this_menu_tooltips['database'] ?>"><label>database</label></a> <span class="pipe">|</span>
        <a class="link link_load" data-step="file_load" data-index="<?= $temp_data_index++ ?>" data-source="frames/frame.file.php?action=load" data-music="misc/file-menu" data-tooltip="<?= $this_menu_tooltips['load'] ?>"><label>load</label></a> <span class="pipe">|</span>
      ...
      // Otherwise, if we're in NORMAL MODE, we process the main menu differently
        ...
        <?php if(rpg_game::screws_unlocked() !== false && rpg_prototype::battles_complete() >= 3){ ?>
          <a class="link link_shop" data-step="shop" data-index="<?= $temp_data_index++ ?>" data-source="frames/frame.shop.php" data-music="misc/shop-music" data-tooltip="<?= $this_menu_tooltips['shop'] ?>" data-tooltip-type="field_type field_type_<?= MMRPG_SETTINGS_CURRENT_FIELDTYPE ?>"><label>shop</label></a> <span class="pipe">|</span>
        <?php } ?>
        <?php if (rpg_prototype::event_complete('completed-chapter_dr-light_one')){ ?>
          <a class="link link_robots" data-step="edit_robots" data-index="<?= $temp_data_index++ ?>" data-source="frames/frame.robots.php?action=robots" data-music="misc/robot-editor" data-tooltip="<?= $this_menu_tooltips['robots'] ?>" data-tooltip-type="field_type field_type_<?= MMRPG_SETTINGS_CURRENT_FIELDTYPE ?>"><label>robots</label></a> <span class="pipe">|</span>
        <?php } ?>
        <?if (rpg_prototype::event_complete('completed-chapter_dr-wily_one')){ ?>
          <a class="link link_players" data-step="edit_players" data-index="<?= $temp_data_index++ ?>" data-source="frames/frame.players.php?action=players" data-music="misc/player-editor" data-tooltip="<?= $this_menu_tooltips['players'] ?>" data-tooltip-type="field_type field_type_<?= MMRPG_SETTINGS_CURRENT_FIELDTYPE ?>"><label>players</label></a> <span class="pipe">|</span>
        <?php } ?>
        <?php if (false && rpg_game::items_unlocked() >= 1){ ?>
          <a class="link link_items" data-step="items" data-index="<?= $temp_data_index++ ?>" data-source="frames/frame.items.php" data-music="misc/item-viewer" data-tooltip="<?= $this_menu_tooltips['items'] ?>" data-tooltip-type="field_type field_type_<?= MMRPG_SETTINGS_CURRENT_FIELDTYPE ?>"><label>items</label></a> <span class="pipe">|</span>
        <?php } ?>
        <?php if (false && rpg_game::abilities_unlocked() >= 3){ ?>
          <a class="link link_abilities" data-step="abilities" data-index="<?= $temp_data_index++ ?>" data-source="frames/frame.abilities.php" data-music="misc/ability-viewer" data-tooltip="<?= $this_menu_tooltips['abilities'] ?>" data-tooltip-type="field_type field_type_<?= MMRPG_SETTINGS_CURRENT_FIELDTYPE ?>"><label>abilities</label></a> <span class="pipe">|</span>
        <?php } ?>
        <?php if(rpg_prototype::event_complete('completed-chapter_dr-light_three')
          ...
          <a class="link link_stars" data-step="starforce" data-index="<?= $temp_data_index++ ?>" data-source="frames/frame.starforce.php" data-music="misc/star-force" data-tooltip="<?= $this_menu_tooltips['starforce'] ?>" data-tooltip-type="field_type field_type_<?= MMRPG_SETTINGS_CURRENT_FIELDTYPE ?>"><label>starforce</label></a> <span class="pipe">|</span>
        <?php } ?>
        <?php if(rpg_game::database_unlocked() >= 2){ ?>
          <a class="link link_data" data-step="database" data-index="<?= $temp_data_index++ ?>" data-source="frames/frame.database.php" data-music="misc/data-base" data-tooltip="<?= $this_menu_tooltips['database'] ?>" data-tooltip-type="field_type field_type_<?= MMRPG_SETTINGS_CURRENT_FIELDTYPE ?>"><label>database</label></a> <span class="pipe">|</span>
        <?php } ?>
  ...
  <div class="menu menu_hide select_this_battle" data-step="2" data-title="Battle Select" data-select="this_battle_token">
    <span class="header block_1">
      <span class="count"><?= rpg_game::is_demo() ? 'Mega Man RPG Prototype' : 'Mission Select' ?></span>
    </span>
    <?php
  ...
  <div class="menu menu_hide menu_file_new" data-step="file_new" data-source="frames/frame.file.php?action=new"></div>

  <div class="menu menu_hide menu_file_load" data-step="file_load" data-source="frames/frame.file.php?action=load"></div>

  <div class="menu menu_hide menu_file_save" data-step="file_save" data-source="frames/frame.file.php?action=save"></div>

  <div class="menu menu_hide menu_shop" data-step="shop" data-source="frames/frame.shop.php"></div>

  <div class="menu menu_hide menu_edit_robots" data-step="edit_robots" data-source="frames/frame.robots.php?action=robots"></div>

  <div class="menu menu_hide menu_edit_players" data-step="edit_players" data-source="frames/frame.players.php?action=players"></div>

  <div class="menu menu_hide menu_leaderboard" data-step="leaderboard" data-source="frames/frame.leaderboard.php"></div>

  <div class="menu menu_hide menu_database" data-step="database" data-source="frames/frame.database.php"></div>

  <div class="menu menu_hide menu_starforce" data-step="starforce" data-source="frames/frame.starforce.php"></div>

  <div class="menu menu_hide menu_help" data-step="help" data-source="frames/frame.help.php"></div>
