 ...
 */
    ...
    if ($unlock_flag_light){
        ...
        //if ($ability_counter_light > 0){ $text_player_subtext .= ' <span class="pipe" style="color: #616161;">|</span> '.($ability_counter_light == 1 ? '1 Ability' : $ability_counter_light.' Abilities'); }
        //if ($star_counter_light > 0){ $text_player_subtext .= ' <span class="pipe" style="color: #616161;">|</span> '.($star_counter_light == 1 ? '1 Star' : $star_counter_light.' Stars'); }
        echo '<a data-music-token="'.$text_player_music.'" data-battle-complete="'.$battle_complete_counter_light.'" class="option option_'.$this_button_size.' option_this-player-select option_this-dr-light-player-select option_dr-light block_1" data-token="dr-light" data-token-id="'.$doctor_info['player_id'].'">';
        echo '<div class="platform"><div class="chrome"><div class="inset">';
    ...
    if ($unlock_flag_wily){
        ...
        echo '<a data-music-token="'.$text_player_music.'" data-battle-complete="'.$battle_complete_counter_wily.'" class="option option_'.$this_button_size.' option_this-player-select option_this-dr-wily-player-select option_dr-wily block_1" data-token="dr-wily" data-token-id="'.$doctor_info['player_id'].'">';
        echo '<div class="platform"><div class="chrome"><div class="inset">';
    ...
    if ($unlock_flag_cossack){
        ...
        echo '<a data-music-token="'.$text_player_music.'" data-battle-complete="'.$battle_complete_counter_cossack.'" class="option option_'.$this_button_size.' option_this-player-select option_this-dr-cossack-player-select option_dr-cossack block_1" data-token="dr-cossack" data-token-id="'.$doctor_info['player_id'].'">';
        echo '<div class="platform"><div class="chrome"><div class="inset">';
