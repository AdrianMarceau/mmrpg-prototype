...
$this_prototype_data['demo_complete'] = rpg_prototype::battle_complete($this_prototype_data['this_player_token'], 'demo-battle-iv') ? true : false;
...
// DEMO BATTLES
if (rpg_prototype::battle_complete($this_prototype_data['this_player_token'], 'demo-battle-iii')){ $this_prototype_data['battle_options']['demo-battle-iv'] = array('battle_token' => 'demo-battle-iv'); }
if (rpg_prototype::battle_complete($this_prototype_data['this_player_token'], 'demo-battle-ii')){ $this_prototype_data['battle_options']['demo-battle-iii'] = array('battle_token' => 'demo-battle-iii'); }
if (rpg_prototype::battle_complete($this_prototype_data['this_player_token'], 'demo-battle-i')){ $this_prototype_data['battle_options']['demo-battle-ii'] = array('battle_token' => 'demo-battle-ii'); }
...
foreach ($this_prototype_data['robot_options'] AS $key => $info){
  if (!rpg_game::robot_unlocked($this_prototype_data['this_player_token'], $info['robot_token'])){ unset($this_prototype_data['robot_options'][$key]); continue; }
