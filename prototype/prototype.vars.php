...
if (!empty($_SESSION[$session_token]['DEMO'])){
  ...
  $point_counter_light = $unlock_flag_light ? rpg_game::player_points('dr-light') : 0;
  $robot_counter_light = $unlock_flag_light ? rpg_game::robots_unlocked('dr-light') : 0;
  //$ability_counter_light = $unlock_flag_light ? rpg_game::abilities_unlocked('dr-light') : 0;
  //$star_counter_light = $unlock_flag_light ? rpg_game::stars_unlocked('dr-light') : 0;
  //$core_counter_light = $unlock_flag_light ? rpg_game::cores_unlocked('dr-light') : 0;
  $battle_complete_counter_light = $unlock_flag_light ? rpg_prototype::battles_complete('dr-light') : 0;
  $battle_failure_counter_light = $unlock_flag_light ? rpg_prototype::battles_failure('dr-light') : 0;
  //$battle_complete_counter_light_total = $unlock_flag_light ? rpg_prototype::battles_complete('dr-light', false) : 0;
  //$battle_failure_counter_light_total = $unlock_flag_light ? rpg_prototype::battles_failure('dr-light', false) : 0;
  $prototype_complete_flag_light = $unlock_flag_light ? rpg_prototype::campaign_complete('dr-light') : false;
 ...
 */
  ...
  $point_counter_wily = $unlock_flag_wily ? rpg_game::player_points('dr-wily') : 0;
  $robot_counter_wily = $unlock_flag_wily ? rpg_game::robots_unlocked('dr-wily') : 0;
  ...
  $chapter_mission_counts['two'] = 9;    // 8 x Single + 1 x Boss
  ...
  $chapters_unlocked_light['four'] = ($battle_complete_counter_light + $battle_complete_counter_wily + $battle_complete_counter_cossack) >= ($chapter_mission_count_totals['three'] * 3) ? true : false;
  ...
  $chapters_unlocked_wily['four'] = ($battle_complete_counter_light + $battle_complete_counter_wily + $battle_complete_counter_cossack) >= ($chapter_mission_count_totals['three'] * 3) ? true : false;
  ...
  $chapters_unlocked_cossack['four'] = ($battle_complete_counter_light + $battle_complete_counter_wily + $battle_complete_counter_cossack) >= ($chapter_mission_count_totals['three'] * 3) ? true : false;
