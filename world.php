...
//error_log('$unlocked_robot_tokens = '.print_r($unlocked_robot_tokens, true));
...
if (!empty($_REQUEST['robots'])){
    ...
    if (!empty($request_robots_filtered)){
        ...
        $current_player_robots = $request_robots_filtered;
...
elseif (!empty($WORLD_PLAYER_SESSION['last_robots'])){
    ...
    $current_player_robots += $last_robots;
}
if (!empty($allowed_player_robots)){
    if (empty($current_player_robots)){
        //error_log('Because empty w/ $current_player_robots = '. print_r($current_player_robots, true));
    ...
    if (!empty($current_player_robots)){
        //error_log('Because NOT empty w/ $current_player_robots = '. print_r($current_player_robots, true));
        //error_log('Filtering by $allowed_player_robots = '. print_r($allowed_player_robots, true));
        $current_player_robots = array_values(array_filter($current_player_robots,
            function($string) use ($allowed_player_robots){
...
if (!empty($current_player_robots) && !empty($allowed_player_robots)){
    ...
    //error_log('(world.php) $current_player_robots = '.print_r($current_player_robots, true));
    //error_log('$allowed_player_robots = '.print_r($allowed_player_robots, true));
    //error_log('$index_tokens_required = '.print_r($index_tokens_required, true));
    foreach ($index_tokens_required AS $robot_string){
        ...
        if (in_array($robot_string, $current_player_robots)){ $this_player_robots[] = $robot_string; }
